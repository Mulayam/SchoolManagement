package com.demomvvm.school.comman;
...
import com.demomvvm.school.revalAnimation.animation.SupportAnimator;
...
public class SheetLayout extends FrameLayout {
    ...
    private void expandPreLollipop(int x, int y, float startRadius, float endRadius) {
        ...
        SupportAnimator toolbarExpandAnim = com.demomvvm.school.revalAnimation.animation.ViewAnimationUtils
    ...
    private void contractPreLollipop(int x, int y, float startRadius, float endRadius) {
        ...
        final SupportAnimator toolbarContractAnim = com.demomvvm.school.revalAnimation.animation.ViewAnimationUtils
