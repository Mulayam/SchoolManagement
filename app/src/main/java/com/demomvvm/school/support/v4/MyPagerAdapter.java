package com.demomvvm.school.support.v4;
 ...
 *
 * <p>
 * PagerAdapter supports data set changes. ClaimDetailModel set changes must occur on the
...
public abstract class MyPagerAdapter {
	 ...
	 *
	 * @param observer
	 *            The {@link DataSetObserver} which will
	 *            receive callbacks.
	 */
	 ...
	 *
	 * @param observer
	 *            The {@link DataSetObserver} which will be
	 *            unregistered.
	 */
	 ...
	 * ViewPager's measured width from (0.f-stra1.f]
	 *
	 * @param position
